...
namespace STREEBOG_CONST {
constexpr static size_t BLOCK_SIZE = 64;

const static vector<uint8_t> SBOX =
...
const static vector<uint8_t> PBOX = {0, 8, 16, 24, 32, 40, 48, 56,
...
const static vector<uint64_t> A = {
...
const static vector<vector<uint8_t>> C = {
